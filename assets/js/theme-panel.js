...
function ath_wp_footer_hook() {
  ...
  <div class="explore_theme_panel">
    ...
    <a href="${buy_link}" title="Buy Now"><i class="fas fa-cart-shopping"></i></a> ${
      wp_demo
...
Looking For WordPress Theme? <a href="${wp_demo}" target="_blank" title="WordPress Theme Demo">View Demo</a>
</div>`;
      ...
      window.addEventListener("scroll", function () {
        if (
          window.scrollY >=
          document.documentElement.scrollHeight - window.innerHeight - 4500
        ) {
